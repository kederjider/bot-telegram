...
```
sudo systemctl stop telegram-relay-bot && rm -f /home/botuser/telegram-relay-bot/bot.py && wget -P /home/botuser/telegram-relay-bot/ https://raw.githubusercontent.com/kederjider/bot-telegram/main/anonim/bot.py && chmod 777 /home/botuser/telegram-relay-bot/bot.py && sudo systemctl start telegram-relay-bot && sudo journalctl -u telegram-relay-bot -f
```
